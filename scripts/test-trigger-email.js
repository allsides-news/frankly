 ...
 * 
 * Usage: Run from firebase/functions directory where firebase-admin is available
 *   cd firebase/functions
 *   node ../../scripts/test-trigger-email.js
 */
...
async function sendTestEmail(toEmail = 'scott@allsides.com') {
  ...
  const emailData = {
    ...
    message: {
      ...
      text: 'This is a test email sent from the allsides-roundtables-db database. The Trigger Email extension is working correctly!',
      html: `
        <h1>✅ Test Email Success!</h1>
        <p>This is a test email sent from the <strong>allsides-roundtables-db</strong> database.</p>
        <p>The Trigger Email extension is working correctly!</p>
        <hr>
...
const emailAddress = process.argv[2] || 'scott@allsides.com';
