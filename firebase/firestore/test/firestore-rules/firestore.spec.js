...
describe("Firestore security rules", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("/publicUser/{userId}", () => {
        ...
        it("authorized, list query by agoraId (getPublicUserByAgoraId)", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield firebase.assertSucceeds(q.get());
        }));
        it("not authorized, list query by agoraId", () => __awaiter(void 0, void 0, void 0, function* () {
            yield communityRulesHelper.getDocumentRef(dbAdmin).set({
                agoraId: 424243,
                id: "alice",
            });
            ...
            yield firebase.assertFails(q.get());
        }));
    });
            ...
            describe("/events/{eventId}", () => {
                ...
                describe("/event-participants/{participantId}", () => {
                    ...
                    describe("request by uid", () => {
                        ...
                        it("public livestream: member can read another user's participant doc", () => __awaiter(void 0, void 0, void 0, function* () {
                            const eventsHelper = new firestore_rules_helper_1.CommunityRulesHelper(dbAdmin, [
                                { collection: collectionCommunity, document: "communityId" },
                                { collection: "templates", document: "templateId" },
                                { collection: "events", document: "eventId" },
                            ]);
                            yield eventsHelper.getDocumentRef(dbAdmin).set({
                                isPublic: true,
                            ...
                            yield participantsCol.doc("alice").set({
                                id: "alice",
                                status: "active",
                            });
                            yield participantsCol.doc("bob").set({
                                id: "bob",
                                status: "active",
                            });
                            yield communityRulesHelper.createMembership("bob", firestore_rules_helper_1.Membership.member);
                            ...
                            const aliceParticipantRef = bobDb
                                ...
                                .collection("event-participants")
                                .doc("alice");
                            yield firebase.assertSucceeds(aliceParticipantRef.get());
                        }));
                        it("private livestream: non-participant member cannot read another user's participant doc", () => __awaiter(void 0, void 0, void 0, function* () {
                            const eventsHelper = new firestore_rules_helper_1.CommunityRulesHelper(dbAdmin, [
                                { collection: collectionCommunity, document: "communityId" },
                                { collection: "templates", document: "templateId" },
                                { collection: "events", document: "eventId" },
                            ...
                            const aliceParticipantRef = bobDb
                                ...
                                .collection("event-participants")
                                .doc("alice");
                            yield firebase.assertFails(aliceParticipantRef.get());
                        }));
                        it("private livestream: active participant can read another user's participant doc", () => __awaiter(void 0, void 0, void 0, function* () {
                            const eventsHelper = new firestore_rules_helper_1.CommunityRulesHelper(dbAdmin, [
                                { collection: collectionCommunity, document: "communityId" },
                                { collection: "templates", document: "templateId" },
                                { collection: "events", document: "eventId" },
