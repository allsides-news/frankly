...
/// Custom time picker class that allow as to embed the time picker without the need
/// of using a dialog, also handles the selected time changes and hide the 'Cancel' and
/// 'OK' buttons. Time picker implementation here: [showTimePicker]
...
class _TimePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    assert(debugCheckHasMediaQuery(context), 'debugCheckHasMediaQuery');
  ...
  bool hitTest(BoxHitTestResult result, {required Offset position}) {
    ...
    return result.addWithRawTransform(
      ...
      hitTest: (result, position) {
        assert(position == newPosition, 'position equals newPosition');
  ...
  Widget build(BuildContext context) {
    ...
    if (inputDecorationTheme != null) {
      ...
      inputDecoration = InputDecoration(
        ...
        // Hide error text due to https://github.com/flutter/flutter/issues/54104
    ...
    //
    // Check for semantics being enabled on web due to https://github.com/flutter/flutter/issues/67571
...
class CustomTimePickerDialog extends StatefulWidget {
  ...
  final Function(TimeOfDay) selectedTimeOfDay;
...
class CustomTimePickerDialogState extends State<CustomTimePickerDialog> {
  ...
  void _handleTimeChanged(TimeOfDay value) {
    ...
    widget.selectedTimeOfDay(value);
  }
