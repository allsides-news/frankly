...
import 'views/pre_post_card_widget_contract.dart';
import '../data/models/pre_post_card_widget_model.dart';
...
class PrePostCardWidgetPresenter {
  ...
  final CloudFunctionsCommunityService _cloudFunctionsService;
  ...
  PrePostCardWidgetPresenter(
    ...
    CloudFunctionsCommunityService? testCloudFunctionsService,
    UserService? userService,
  })  : _helper = prePostCardWidgetPresenterHelper ??
            PrePostCardWidgetPresenterHelper(),
        _cloudFunctionsService =
            testCloudFunctionsService ?? cloudFunctionsCommunityService,
        _userService =
...
class PrePostCardWidgetPresenterHelper {
  ...
  Future<String?> getEmail(
    UserService userService,
    CloudFunctionsCommunityService cloudFunctionsService,
  ) async {
